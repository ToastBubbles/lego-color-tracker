var sortRow = 0;
var showUnofficialNames = true;
var showSpecialColors = false;
var showModulexColors = true;
var showModulexFoilColors = false;
...
function generateTableRow(tableRowData){
    ...
    return `<tr>
        <td bgcolor=#${tableRowData.color} class="trtxt size1${cellPattern}">${tableRowData.swatchId}</td>
        <td>${nameToggleBL}</td>
